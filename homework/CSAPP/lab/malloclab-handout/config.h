...
#define DEFAULT_TRACEFILES                                                                         \
  "amptjp-bal.rep", "cccp-bal.rep", "cp-decl-bal.rep", "expr-bal.rep", "coalescing-bal.rep",       \
      "random-bal.rep", "random2-bal.rep", "binary-bal.rep", "binary2-bal.rep", "realloc-bal.rep", \
      "realloc2-bal.rep"
